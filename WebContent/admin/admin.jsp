...
<style>
.list_td1 a { color: black; }
.list_td1 a:link { color: black; }
.list_td1 a:visited { color: black; }
</style>
            ...
            <table border="0" class="userlist_table">
                ...
                <tr>
                    ...
                    <td colspan="2" class="list_td1">
                     <center>	
                         <a href="/AdminMain.do?curpage=1"><font color="RGB(46,46,46)">◀◀</font></a>
                         ...
                         if(curpage<2){out.print(1);}
                        		 ...
                        		 if(sub == null){out.print("");}
                        				 ...
                        				 if(date==null){out.print("");}
                        						 ...
                        						 else{out.print(name);}%>"><font color="RGB(46,46,46)">◀</font></a>
                        <%
                        ...
                        %>
                        		...
                        		if(sub==null){out.print("");}
                        				...
                        				if(date==null){out.print("");}
                        						...
                        						if(name==null){out.print("");}
                        						else{out.print(name);}%>"><% if(curpage == i){out.print("<b><font color='purple'>");}%><%=i%><% if(curpage == i){out.print("</font></b> ");}%></a>
                        <%	}
                        %>
                        <a href="/AdminMain.do?curpage=<%
                        ...
                        <a href="/AdminMain.do?curpage=<%=maxpage%>"><font color="RGB(46,46,46)">▶▶</font></a>
                    </td>
                     </center>
                </tr>
            </table>
